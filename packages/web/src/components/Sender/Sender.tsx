    ...
    >
      ...
      <div className="input-wrapper">
        <textarea
          ...
          className="w-full h-full scrollbar bg-transparent border-none p-1 outline-none resize-none placeholder-[#b4b4b4] text-size-base dark:text-[var(--ant-layout-color-text-body)] dark:placeholder-[var(--ant-layout-color-text-body)]"
        />
      </div>
