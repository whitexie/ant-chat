...
import type { AddMcpConfigSchema, McpConfigSchema, UpdateConversationsSchema, UpdateMcpConfigSchema } from './schemas'
...
export type IpcEvents =
  ...
  | {
    ...
    'mcp:callTool': (serverName: string, toolName: string, toolArguments?: Record<string, unknown>) => Promise<IpcResponse<McpToolCallResponse>>
    'mcp:connectMcpServer': (name: string, mcpConfig: McpConfigSchema) => Promise<IpcResponse<null>>
    'mcp:disconnectMcpServer': (name: string) => Promise<IpcResponse<null>>
    'mcp:reconnectMcpServer': (name: string, mcpConfig: McpConfigSchema) => Promise<IpcResponse<null>>
